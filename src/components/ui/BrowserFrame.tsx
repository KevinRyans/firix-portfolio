...
export default function BrowserFrame({
  ...
  return (
    <div
      className={cn(
        'overflow-hidden rounded-card border border-line-soft bg-surface shadow-chrome',
        className,
      )}
    >
      <div
        className={cn(
          'flex items-center gap-2 border-b border-line-soft bg-muted/80 px-3',
      ...
      >
        ...
        <div className="mx-auto flex min-w-0 max-w-[60%] items-center gap-1.5 rounded-md bg-surface/90 px-2.5 py-1">
          <svg
            viewBox="0 0 12 12"
            className="h-2.5 w-2.5 shrink-0 text-ink-ghost"
            aria-hidden="true"
          >
            <path
              fill="currentColor"
          ...
          <span className="truncate text-[11px] font-medium text-ink-faint">{host}</span>
        </div>
